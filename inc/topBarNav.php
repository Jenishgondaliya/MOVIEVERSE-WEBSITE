    ...
    <div class="d-flex justify-content-between w-100">
        ...
        <div>
            ...
            <div class="cla">
                ...
                <a href="./register.php" class="mx-2 text-darkmagenta">Register</a>
                <a href="./login.php" class="mx-2 text-darkmagenta">User Login</a>
                <a href="./admin" class="mx-2 text-darkmagenta">Admin Login</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="./?page=movies"
                        class="nav-link <?= isset($page) && $page =='movies' && !isset($_GET['gid']) && !isset($_GET['search']) ? "active" : "" ?>">All
                        Movies</a>
                </li>
                <li class="nav-item dropdown">
                    <a id="dropdowngenremenu" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                  ...
                  while($row = $genre_qry->fetch_assoc()):
                    $i++;
                  ?>
                        <li><a href="./?page=movies&genre=<?= urlencode($row['name']) ?>&gid=<?= $row['id'] ?>"
                ...
                <li class="nav-item">
                    <a href="./?page=search"
                        class="nav-link <?= isset($page) && $page =='search' ? "active" : "" ?>">Search Movie</a>
                </li>
                <li class="nav-item">
                    <a href="./?page=about"
